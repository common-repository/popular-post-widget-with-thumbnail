...
== Screenshots ==
1. Install plugin from Plugin-> add new -> upload plugin -> PopularPostWidgetwithThumbnail.zip
2. Use widget go to Appearance -> widgets > Popular Post Widget with Thumbnail
3. Initial front-end view of popular posts.
